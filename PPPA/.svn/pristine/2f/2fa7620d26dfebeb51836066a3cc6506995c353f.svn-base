...
{
    public partial class Export_Accuracy_Above_96 : System.Web.UI.Page
    {
        string date;
        string fromDate;
        string toDate;
          ...
          protected void btnExport_Click(object sender, EventArgs e)
        {
            if (txtMonth.Text != "" && txtMonth.Text != null)
            {
                ...
                var finalAccuracyList = new AccuracyPercentage().FindByMonthForAbove96P(branchcode, Month1, probesQty, 96, fromDate, toDate, Month2, FromDate2, ToDate2);  // total probes is equal 7500
