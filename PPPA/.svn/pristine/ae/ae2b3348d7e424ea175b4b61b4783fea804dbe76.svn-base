...
{
    public partial class Export_Accuracy_3PA_Org : System.Web.UI.Page
    {
        string date;
        string fromDate;
        string toDate;
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            if (txtMonth.Text != "" && txtMonth.Text != null)
            {
               ...
               // FindByMonthFor3PA(branchcode, GeneralUtility.ConvertMonthYearStringFormat(txtMonth.Text.Trim()),fromDate,toDate,month2,fromDate2,toDate2);
                ...
                var finalAccuracyList = new AccuracyPercentage().FindByMonthFor3PA(branchcode, Month1, fromDate, toDate, Month2, FromDate2, ToDate2);
