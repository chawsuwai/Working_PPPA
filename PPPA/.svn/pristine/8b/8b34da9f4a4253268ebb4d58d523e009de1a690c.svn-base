<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Export_Accuracy_Above_GSS.aspx.cs" Inherits="PPP_Project.Export_Accuracy_Above_GSS" %>
        ...
        <div class="col-lg-12">
            <div class="panel">
                <div class="panel-heading">
                    Excel Export Accuracy Over 96%+7.5K Lists | IGS - PPPA System
                </div>
