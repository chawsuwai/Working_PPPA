<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Export_Accuracy_Under_GSS.aspx.cs" Inherits="PPP_Project.Export_Accuracy_Under_GSS" %>
        ...
        <div class="col-lg-12">
            <div class="panel">
                <div class="panel-heading">
                    Excel Export Accuracy Under 96% Lists | IGS - PPPA System
                </div>
