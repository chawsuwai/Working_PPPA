...
{
    public partial class Export_Accuracy_Above_GSS : System.Web.UI.Page
    {
        string date;
        string fromDate;
        string toDate;
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            if (txtMonth.Text != "" && txtMonth.Text != null)
            {
                ...
                //var finalAccuracyList = new AccuracyPercentage().FindByMonthForAbove96P(branchcode, GeneralUtility.ConvertMonthYearStringFormat(txtMonth.Text.Trim()), 7500, 96);  // total probes is equal 7500
                var finalAccuracyList = new AccuracyPercentage().FindByMonthForAboveGSS(branchcode, cMonth2, probesQty, 96, fromDate, toDate, Month2, FromDate2, ToDate2);  // total probes is equal 7500
                ...
                {
                    var fileName = "AccuracyAbove96%" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    ...
                    using (pkg)
                    {
                        ...
                        ExcelWorksheet ws = pkg.Workbook.Worksheets.Add("Over 96%+5K");
