<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ProjectDenominatorMonthlySetup.aspx.cs" Inherits="PPP_Project.ProjectDenominatorMonthlySetup" %>
        ...
        <div class="col-lg-12">
            <div class="panel">
                <div class="panel-heading">
                    Project Denominators Monthly Setup| IGS - PPPA System
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        <div class="controls">
                            ...
                            <asp:TextBox ID="txtProject" runat="server" Width="190px" Height="34px"></asp:TextBox>
                        </div>
                    </div>
