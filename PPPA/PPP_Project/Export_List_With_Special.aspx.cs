...
{
    public partial class Export_List_With_Special : System.Web.UI.Page
   {
        string fromDate;
        string toDate;
        string eve = "Submit";
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            calculateMonth = GeneralUtility.ConvertMonthYearStringFormat(txtImportDate.Text.Trim());
            ...
            if (ddlJobName.SelectedValue == "All")
            {
                ...
                }.FindByCriteriaDenominatorForAllSpecial();
                ...
                {
                    var fileName = "SpecialDenominatorList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
            ...
            if (ddlJobName.SelectedValue == "Probes")
            {
                ...
                }.FindByCriteriaDenominatorForProbesSpecial();
                ...
                {
                    var fileName = "SpecialDenominatorProbesList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Pricing Probes")
            {
                ...
                }.FindByCriteriaDenominatorForPricingProbesSpecial();
                ...
                {
                    var fileName = "SpecialDenominatorPricingProbesList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Masks")
            {
                ...
                }.FindByCriteriaDenominatorForMasksSpecial();
                ...
                {
                    var fileName = "SpecialDenominatorMasksList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Votes")
            {
                ...
                }.FindByCriteriaDenominatorForVotesSpecial();
                ...
                {
                    var fileName = "SpecialDenominatorVotesList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Repricing")
            {
                ...
                }.FindByCriteriaDenominatorForRepricingSpecial();
                ...
                {
                    var fileName = "SpecialDenominatorRepricingList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Scenes")
            {
                ...
                }.FindByCriteriaDenominatorForScenesSpecial();
                ...
                {
                    var fileName = "SpecialDenominatorScenesList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Scene Recognition")
            {
                ...
                }.FindByCriteriaDenominatorForSceneRecognitionSpecial();
                ...
                {
                    var fileName = "SpecialDenominatorSceneRecognitionList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Category Expert")
            {
                ...
                }.FindByCriteriaDenominatorForCategoryExpertSpecial();
                ...
                {
                    var fileName = "SpecialDenominatorCategoryExpertList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Category Expert Voting")
            {
                ...
                }.FindByCriteriaDenominatorForCategoryExpertVotingSpecial();
                ...
                {
                    var fileName = "SpecialDenominatorCategoryExpertVotingList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Category Expert Hunt")
            {
                ...
                }.FindByCriteriaDenominatorForCategoryExpertHuntSpecial();
                ...
                {
                    var fileName = "SpecialDenominatorCategoryExpertHuntList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
