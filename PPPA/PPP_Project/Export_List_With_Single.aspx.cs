...
{
    public partial class Export_List_With_Single : System.Web.UI.Page
    {
        string fromDate;
        string toDate;
        string eve = "Submit";
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            calculateMonth = GeneralUtility.ConvertMonthYearStringFormat(txtImportDate.Text.Trim());  //Month

            //calculateFromDate = calculateMonth + "16";  //calculateFromDate          

            calculateToDate = calculateMonth + "15";  //calculateToDate          

            //string calculatedate = new AccuracyPercentage().FindMonthAndYear(calculateFromDate);
            ...
            if (ddlJobName.SelectedValue == "All")
            {
                ...
                }.FindByCriteriaDenominatorForAllSingle();
                ...
                {
                    var fileName = "SingleDenominatorList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
            ...
            if (ddlJobName.SelectedValue == "Probes")
            {
                ...
                }.FindByCriteriaDenominatorForProbesSingle();
                ...
                {
                    var fileName = "SingleDenominatorProbesList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Pricing Probes")
            {
                ...
                }.FindByCriteriaDenominatorForPricingProbesSingle();
                ...
                {
                    var fileName = "SingleDenominatorPricingProbesList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Masks")
            {
                ...
                }.FindByCriteriaDenominatorForMasksSingle();
                ...
                {
                    var fileName = "SingleDenominatorMasksList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Votes")
            {
                ...
                }.FindByCriteriaDenominatorForVotesSingle();
                ...
                {
                    var fileName = "SingleDenominatorVotesList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Repricing")
            {
                ...
                }.FindByCriteriaDenominatorForRepricingSingle();
                ...
                {
                    var fileName = "SingleDenominatorRepricingList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Scenes")
            {
                ...
                }.FindByCriteriaDenominatorForScenesSingle();
                ...
                {
                    var fileName = "SingleDenominatorScenesList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Scene Recognition")
            {
                ...
                }.FindByCriteriaDenominatorForSceneRecognitionSingle();
                ...
                {
                    var fileName = "SingleDenominatorSceneRecognitionList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Category Expert")
            {
                ...
                }.FindByCriteriaDenominatorForCategoryExpertSingle();
                ...
                {
                    var fileName = "SingleDenominatorCategoryExpertList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Category Expert Voting")
            {
                ...
                }.FindByCriteriaDenominatorForCategoryExpertVotingSingle();
                ...
                {
                    var fileName = "SingleDenominatorCategoryExpertVotingList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Category Expert Hunt")
            {
                ...
                }.FindByCriteriaDenominatorForCategoryExpertHuntSingle();
                ...
                {
                    var fileName = "SingleDenominatorCategoryExpertHuntList" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
