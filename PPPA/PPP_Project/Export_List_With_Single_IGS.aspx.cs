...
{
    public partial class Export_List_With_Single_IGS : System.Web.UI.Page
    {
        string fromDate;
        string toDate;
        string eve = "Submit";
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (ddlJobName.SelectedValue == "All")
            {
                ...
                }.FindByCriteriaDenominatorForAllSingleIGS();
                ...
                {
                    var fileName = "SingleDenominatorListIGS" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
            ...
            if (ddlJobName.SelectedValue == "Probes")
            {
                ...
                }.FindByCriteriaDenominatorForProbesSingleIGS();
                ...
                {
                    var fileName = "SingleDenominatorProbesListIGS" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Pricing Probes")
            {
                ...
                }.FindByCriteriaDenominatorForPricingProbesSingleIGS();
                ...
                {
                    var fileName = "SingleDenominatorPricingProbesListIGS" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Masks")
            {
                ...
                }.FindByCriteriaDenominatorForMasksSingleIGS();
                ...
                {
                    var fileName = "SingleDenominatorMasksListIGS" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Votes")
            {
                ...
                }.FindByCriteriaDenominatorForVotesSingleIGS();
                ...
                {
                    var fileName = "SingleDenominatorVotesListIGS" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Repricing")
            {
                ...
                }.FindByCriteriaDenominatorForRepricingSingleIGS();
                ...
                {
                    var fileName = "SingleDenominatorRepricingListIGS" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Scenes")
            {
                ...
                }.FindByCriteriaDenominatorForScenesSingleIGS();
                ...
                {
                    var fileName = "SingleDenominatorScenesListIGS" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Scene Recognition")
            {
                ...
                }.FindByCriteriaDenominatorForSceneRecognitionSingleIGS();
                ...
                {
                    var fileName = "SingleDenominatorSceneRecognitionListIGS" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Category Expert")
            {
                ...
                }.FindByCriteriaDenominatorForCategoryExpertSingleIGS();
                ...
                {
                    var fileName = "SingleDenominatorCategoryExpertListIGS" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
            ...
            else if (ddlJobName.SelectedValue == "Category Expert Voting")
            {
                ...
                {
                    var fileName = "SingleDenominatorCategoryExpertVotingListIGS" + mm + "'" + yy + ".xlsx";
                    int count = 0;
                    Response.Clear();
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    //Response.AddHeader("content-disposition", "attachment;filename=" + HttpUtility.UrlEncode("Probes_List_Export.xlsx", System.Text.Encoding.UTF8));
