...
{
    public class CategoryExpertHuntDAO : DAO<CategoryExpertHuntEntity>
    {
        ...
        public override void Save()
        {
            try
            {
                ExcuteInsertCommand<CategoryExpertHuntEntity>(Entity, ConnectionDAO.Client.ToConnectionString());
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public override List<CategoryExpertHuntEntity> FindByCriteria()
        {
            try
            {
                var sql = " SELECT * FROM " + Table<CategoryExpertHuntEntity>() + " WHERE 1=1";
                var param = new List<DbParameter>();

                if (!string.IsNullOrEmpty(Criteria.CenterName))
                {
                    sql += " AND " + With<CategoryExpertHuntEntity>(x => x.Center) + "= @CenterName";
                ...
                {
                    sql += " AND " + With<CategoryExpertHuntEntity>(x => x.CreatedDate) + " BETWEEN @FromDate AND @ToDate";
                ...
                return ExcuteStoreQuery<CategoryExpertHuntEntity>(sql, param, ConnectionDAO.Client.ToConnectionString());
        ...
        public override void Delete()
        {
            try
            {
                ExcuteDeleteCommand<CategoryExpertHuntEntity>(Entity, ConnectionDAO.Client.ToConnectionString());
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public override void Update()
        {
            try
            {
                ExcuteUpdateCommand<CategoryExpertHuntEntity>(Entity, ConnectionDAO.Client.ToConnectionString());
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public override List<CategoryExpertHuntEntity> FindByModelCode(string modelCode)
        {
            throw new NotImplementedException();
        }
        ...
        public List<CategoryExpertHuntEntity> FindByImportedDateAndCenter(string importDate, string center)
        {
            try
            {
                ...
                var sql = "SELECT * FROM " + Table<CategoryExpertHuntEntity>() + " WHERE " + With<CategoryExpertHuntEntity>(x => x.ImportedDate) + "=@ImpDate" + " AND " + With<CategoryExpertHuntEntity>(x => x.Center) + "=@Center";
        ...
        public List<ExportViewWithoutDe> FindByCriteriaWithoutDeForCategoryExpertHunt()
        {
            try
            {
                var sql = "Exec Export_WithoutDe_CategoryExpertHunt";
                var param = new List<DbParameter>();
        ...
        public List<ExportCategoryExpertHunt> FindByCriteriaDenominatorForCategoryExpertHunt()
        {
            try
            {
                var sql = "Exec Export_WithDe_CategoryExpertHunt_DiffMonth";
                var param = new List<DbParameter>();
                ...
                return ExcuteStoreQuery<ExportCategoryExpertHunt>(sql, param, ConnectionDAO.Client.ToConnectionString());
        ...
        public List<ExportCategoryExpertHunt> FindByCriteriaDenominatorForCategoryExpertHuntSingle()
        {
            try
            {
                var sql = "Exec Export_WithDe_CategoryExpertHunt_DiffMonth_GSS";
                var param = new List<DbParameter>();
        ...
        public List<ExportCategoryExpertHunt> FindByCriteriaDenominatorForCategoryExpertHuntSingleIGS()
        {
            try
            {
                var sql = "Exec Export_WithDe_CategoryExpertHunt_DiffMonth_IGS";
                var param = new List<DbParameter>();
        ...
        public List<ExportCategoryExpertHunt> FindByCriteriaDenominatorForCategoryExpertHuntSpecial()
        {
            try
            {
                var sql = "Exec Export_WithDe_CategoryExpertHunt_DiffMonth_Special";
                var param = new List<DbParameter>();
        ...
        public void ReplaceQATCategoryExpertHunt(string center)
        {
            ...
            try
            {
                ...
                connection.Open();
                string sql = "Replace_QAT_CategoryExpertHunt";
