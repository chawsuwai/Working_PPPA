...
{
    public class MasksDAO:DAO<MasksEntity>
    {
        ...
        public override void Save()
        {
            try
            {
                ExcuteInsertCommand<MasksEntity>(Entity,ConnectionDAO.Client.ToConnectionString());
            }
            catch (Exception ex)
            {
        ...
        public override List<MasksEntity> FindByCriteria()
        {
            try
            {
                var sql = " SELECT * FROM " + Table<MasksEntity>() + " WHERE 1=1";
                var param = new List<DbParameter>();

                if (!string.IsNullOrEmpty(Criteria.CenterName))
                {
                    sql += " AND " + With<MasksEntity>(x => x.Center) + "= @CenterName";
                ...
                {
                    sql += " AND " + With<MasksEntity>(x => x.CreatedDate) + " BETWEEN @FromDate AND @ToDate";
                ...
                return ExcuteStoreQuery<MasksEntity>(sql, param, ConnectionDAO.Client.ToConnectionString());
        ...
        public List<MasksEntity> FindMasksJobImportList()
        {
            try
            {
                var sql = " SELECT Masks.QAT,Masks.Center,Masks.TotalMasks FROM " + Table<MasksEntity>() + " WHERE 1=1";
                var param = new List<DbParameter>();
        ...
        public override void Delete()
        {
            try
            {
                ExcuteDeleteCommand<MasksEntity>(Entity,ConnectionDAO.Client.ToConnectionString());
            }
            catch (Exception ex)
            {                
                throw ex;
        ...
        public override void Update()
        {
            try
            {
                ExcuteUpdateCommand<MasksEntity>(Entity,ConnectionDAO.Client.ToConnectionString());
            }
            catch (Exception ex)
            {                
                throw ex;
        ...
        public override List<MasksEntity> FindByModelCode(string modelCode)
        {
            throw new NotImplementedException();
        }
        ...
        public List<MasksEntity> FindByImportedDateAndCenter(string importDate, string center)
        {
            try
            {
                ...
                var sql = "SELECT * FROM " + Table<MasksEntity>() + " WHERE " + With<MasksEntity>(x => x.ImportedDate) + "=@ImpDate" + " AND " + With<MasksEntity>(x => x.Center) + "=@Center"; 
        ...
        public List<ExportViewWithoutDe> FindByCriteriaWithoutDeForMasks()
        {
            try
            {
                var sql = "Exec Export_WithoutDe_Masks";
                var param = new List<DbParameter>();
        ...
        public List<ExportMasks> FindByCriteriaDenominatorForMasks()
        {
            try
            {
                var sql = "Exec Export_WithDe_Masks_DiffMonth";
                var param = new List<DbParameter>();
                ...
                return ExcuteStoreQuery<ExportMasks>(sql, param, ConnectionDAO.Client.ToConnectionString());
        ...
        public List<ExportMasks> FindByCriteriaDenominatorForMasksSingle()
        {
            try
            {
                var sql = "Exec Export_WithDe_Masks_DiffMonth_GSS";
                var param = new List<DbParameter>();
        ...
        public List<ExportMasks> FindByCriteriaDenominatorForMasksSingleIGS()
        {
            try
            {
                var sql = "Exec Export_WithDe_Masks_DiffMonth_IGS";
                var param = new List<DbParameter>();
        ...
        public List<ExportMasks> FindByCriteriaDenominatorForMasksSpecial()
        {
            try
            {
                var sql = "Exec Export_WithDe_Masks_DiffMonth_Special";
                var param = new List<DbParameter>();
        ...
        public List<ExportMasksOther> FindByCriteriaDenominatorForMasksDetail()
        {
            try
            {
                var sql = "Exec Export_WithoutDe_Masks_Other";
                var param = new List<DbParameter>();
                ...
                return ExcuteStoreQuery<ExportMasksOther>(sql, param, ConnectionDAO.Client.ToConnectionString());
