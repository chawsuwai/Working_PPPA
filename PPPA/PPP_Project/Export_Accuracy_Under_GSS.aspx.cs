...
{
    public partial class Export_Accuracy_Under_GSS : System.Web.UI.Page
    {
        string date;
        string fromDate;
        string toDate;
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            if (txtMonth.Text != "" && txtMonth.Text != null)
            {
                ...
                var finalAccuracyList = new AccuracyPercentage().FindByMonthForUnderGSS(branchcode, cMonth2, probesQty, 96, fromDate, toDate, Month2, FromDate2, ToDate2);
